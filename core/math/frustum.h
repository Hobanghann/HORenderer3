...
namespace ho {
    ...
    struct Frustum {
        ...
        Frustum(const Plane& left, const Plane& right, const Plane& bottom, const Plane& top, const Plane& near,
                const Plane& far);
        ...
        math::Side GetSide(const Vector3& p1, const Vector3& p2, const Vector3& p3) const;
