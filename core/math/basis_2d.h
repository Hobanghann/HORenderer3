...
constexpr Basis2D::Basis2D(real scale_x, real scale_y, const Vector2& basis_x,
                  const Vector2& basis_y)
    : row0(scale_x * basis_x.x, scale_y * basis_y.x),
      row1(scale_x * basis_x.y, scale_y * basis_y.y) {}
