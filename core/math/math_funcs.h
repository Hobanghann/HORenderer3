...
namespace ho {
    namespace math {
        ...
        ALWAYS_INLINE void SinCos(float& out_sin, float& out_cos, float radian) {
            ...
            out_sin = (((((-2.3889859e-08f * y2 + 2.7525562e-06f) * y2 - 0.00019840874f) * y2 + 0.0083333310f) * y2 -
                        0.16666667f) *
                           y2 +
                       1.0f) *
                      y;
            ...
            float p =
                ((((-2.6051615e-07f * y2 + 2.4760495e-05f) * y2 - 0.0013888378f) * y2 + 0.041666638f) * y2 - 0.5f) *
                    y2 +
                1.0f;
            out_cos = sign * p;
        }
