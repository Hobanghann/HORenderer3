...
namespace ho {
    ...
    constexpr bool Color128::operator!=(const Color128& rhs) const { return !(*this == rhs); }
    ...
    constexpr bool Color128::IsNotEqualApprox(const Color128& rhs) const { return !IsEqualApprox(rhs); }
