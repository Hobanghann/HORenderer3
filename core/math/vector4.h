...
constexpr Vector4::Vector4(real p_x, real p_y, real p_z, real p_w)
    : x(p_x), y(p_y), z(p_z), w(p_w) {}

_INLINE_ constexpr Vector4 Vector4::UNIT_X =
    Vector4(1.0_r, 0.0_r, 0.0_r, 0.0_r);
_INLINE_ constexpr Vector4 Vector4::UNIT_Y =
    Vector4(0.0_r, 1.0_r, 0.0_r, 0.0_r);
_INLINE_ constexpr Vector4 Vector4::UNIT_Z =
    Vector4(0.0_r, 0.0_r, 1.0_r, 0.0_r);
_INLINE_ constexpr Vector4 Vector4::UNIT_W =
...
_ALWAYS_INLINE_ constexpr Vector4 operator*(real scalar,
...
constexpr bool Vector4::IsEqualApprox(const Vector4& rhs) const {
  return math::IsEqualApprox(x, rhs.x) && math::IsEqualApprox(y, rhs.y) &&
         math::IsEqualApprox(z, rhs.z) && math::IsEqualApprox(w, rhs.w);
}
constexpr bool Vector4::IsNotEqualApprox(const Vector4& rhs) const {
  return !IsEqualApprox(rhs);
}

constexpr real ho::Vector4::Dot(const Vector4& rhs) const {
  return x * rhs.x + y * rhs.y + z * rhs.z + w * rhs.w;
}
