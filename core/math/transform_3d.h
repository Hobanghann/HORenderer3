...
namespace ho {
    ...
    constexpr Transform3D::Transform3D() : basis(Basis3D()), origin(Vector3::ZERO) {}

    constexpr Transform3D::Transform3D(const Basis3D& p_basis, const Vector3& p_origin)
    ...
    constexpr void Transform3D::set_basis_x(const Vector3& basis_x) { basis.set_basis_x(basis_x); }
    constexpr void Transform3D::set_basis_y(const Vector3& basis_y) { basis.set_basis_y(basis_y); }
    constexpr void Transform3D::set_basis_z(const Vector3& basis_z) { basis.set_basis_z(basis_z); }

    constexpr bool Transform3D::operator==(const Transform3D& rhs) const {
        return basis == rhs.basis && origin == rhs.origin;
    }
    constexpr bool Transform3D::operator!=(const Transform3D& rhs) const { return !(*this == rhs); }
    ...
    constexpr bool Transform3D::IsNotEqualApprox(const Transform3D& rhs) const { return !IsEqualApprox(rhs); }

    constexpr bool Transform3D::IsOrthogonal() const { return basis.IsOrthogonal(); }
    ...
    constexpr bool Transform3D::IsOrthonormal() const { return basis.IsOrthonormal(); }
    ...
    constexpr Transform3D Transform3D::Translated(const Vector3& translation_v) const {
        Transform3D copy = *this;
    ...
    constexpr Transform3D& Transform3D::TranslateLocal(const Vector3& translation_v) {
        origin += basis_x() * translation_v.x + basis_y() * translation_v.y + basis_z() * translation_v.z;
        return *this;
    }
    ...
    constexpr Transform3D Transform3D::TranslatedLocal(const Vector3& translation_v) const {
        Transform3D copy = *this;
    ...
    constexpr Vector3 Transform3D::Transform(const Vector3& v) const { return basis.Transform(v) + origin; }
