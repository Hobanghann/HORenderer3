...
TEST_F(Basis3DTest, Constructors) {
    ...
    Matrix3x3 m(Vector3(1.0_r, 2.0_r, 3.0_r), Vector3(4.0_r, 5.0_r, 6.0_r), Vector3(7.0_r, 8.0_r, 9.0_r));
    Basis3D b_from_m(m);
...
TEST_F(Basis3DTest, ComparisonOperators) {
    Basis3D b1(Vector3(1.0_r, 0.0_r, 0.0_r), Vector3(0.0_r, 1.0_r, 0.0_r), Vector3(0.0_r, 0.0_r, 1.0_r));
    Basis3D b2 = b1;
    Basis3D b3 = b_scale;
...
TEST_F(Basis3DTest, ApproximateEqualityCheck) {
    Basis3D b1(Vector3(1.0_r, 0.0_r, 0.0_r), Vector3(0.0_r, 1.0_r, 0.0_r), Vector3(0.0_r, 0.0_r, 1.0_r));
    Basis3D b2(Vector3(1.000001_r, 0.0_r, 0.0_r), Vector3(0.0_r, 1.000001_r, 0.0_r), Vector3(0.0_r, 0.0_r, 0.999999_r));
...
TEST_F(Basis3DTest, Scaling) {
    Basis3D b(Vector3(1.0_r, 2.0_r, 3.0_r), Vector3(0.0_r, 1.0_r, 1.0_r), Vector3(1.0_r, 0.0_r, 1.0_r));
    ...
    Matrix3x3 m_scale(Vector3(2.0_r, 0.0_r, 0.0_r), Vector3(0.0_r, 2.0_r, 0.0_r), Vector3(0.0_r, 0.0_r, 2.0_r));
...
TEST_F(Basis3DTest, RotationEuler) {
    Basis3D b(Vector3(1.0_r, 2.0_r, 3.0_r), Vector3(4.0_r, 5.0_r, 6.0_r), Vector3(7.0_r, 8.0_r, 9.0_r));
    Basis3D b1;

    b1 = b;
    b1.RotateEuler(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, XYZ);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b_pitch.matrix * b_yaw.matrix * b_roll.matrix * b.matrix));

    b1 = b;
    b1.RotateEuler(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, XZY);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b_pitch.matrix * b_roll.matrix * b_yaw.matrix * b.matrix));

    b1 = b;
    b1.RotateEuler(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, YZX);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b_yaw.matrix * b_roll.matrix * b_pitch.matrix * b.matrix));

    b1 = b;
    b1.RotateEuler(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, YXZ);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b_yaw.matrix * b_pitch.matrix * b_roll.matrix * b.matrix));

    b1 = b;
    b1.RotateEuler(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, ZXY);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b_roll.matrix * b_pitch.matrix * b_yaw.matrix * b.matrix));

    b1 = b;
    b1.RotateEuler(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, ZYX);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b_roll.matrix * b_yaw.matrix * b_pitch.matrix * b.matrix));
...
TEST_F(Basis3DTest, RotationAxisAngle) {
    Basis3D b(Vector3(1.0_r, 2.0_r, 3.0_r), Vector3(4.0_r, 3.0_r, 6.0_r), Vector3(7.0_r, 6.0_r, 9.0_r));
...
TEST_F(Basis3DTest, RotationEulerLocal) {
    ...
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b.matrix * b_pitch.matrix * b_yaw.matrix * b_roll.matrix));

    b1 = b;
    b1.RotateEulerLocal(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, XZY);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b.matrix * b_pitch.matrix * b_roll.matrix * b_yaw.matrix));

    b1 = b;
    b1.RotateEulerLocal(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, YZX);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b.matrix * b_yaw.matrix * b_roll.matrix * b_pitch.matrix));

    b1 = b;
    b1.RotateEulerLocal(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, YXZ);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b.matrix * b_yaw.matrix * b_pitch.matrix * b_roll.matrix));

    b1 = b;
    b1.RotateEulerLocal(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, ZXY);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b.matrix * b_roll.matrix * b_pitch.matrix * b_yaw.matrix));

    b1 = b;
    b1.RotateEulerLocal(PI / 4.0_r, PI / 4.0_r, PI / 4.0_r, ZYX);
    EXPECT_TRUE(b1.matrix.IsEqualApprox(b.matrix * b_roll.matrix * b_yaw.matrix * b_pitch.matrix));
...
TEST_F(Basis3DTest, Multiplication) {
    Basis3D b1(Vector3(1.0_r, 2.0_r, 3.0_r), Vector3(0.0_r, 1.0_r, 2.0_r), Vector3(3.0_r, 0.0_r, 1.0_r));

    Basis3D b2(Vector3(2.0_r, 0.0_r, 1.0_r), Vector3(1.0_r, 2.0_r, 0.0_r), Vector3(0.0_r, 1.0_r, 3.0_r));
...
TEST_F(Basis3DTest, TransformAndInvTransform) {
    ...
    EXPECT_TRUE(b_pitch.InvTransformFast(v).IsEqualApprox(b_pitch.matrix.Inverse() * v));
}
