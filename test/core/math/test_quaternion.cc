...
TEST(QuaternionTest, ScalarDivision) {
  ...
  EXPECT_TRUE((q / 2.0_r).IsEqualApprox(
      Quaternion(2.0_r / 2.0_r, 4.0_r / 2.0_r, 6.0_r / 2.0_r, 8.0_r / 2.0_r)));

  q /= 2.0_r;
  EXPECT_TRUE(q.IsEqualApprox(
      Quaternion(2.0_r / 2.0_r, 4.0_r / 2.0_r, 6.0_r / 2.0_r, 8.0_r / 2.0_r)));
...
TEST(QuaternionTest, DotProduct) {
  ...
  real dot = q1.Dot(q2);
  EXPECT_NEAR(dot,
              1.0_r * 5.0_r + 2.0_r * 6.0_r + 3.0_r * 7.0_r + 4.0_r * 8.0_r,
              math::EPSILON_CMP);
}
