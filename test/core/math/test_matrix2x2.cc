...
class Matrix2x2Test : public ::testing::Test {
   protected:
    void SetUp() override {
        ...
        m_orthogonal = Matrix2x2(Vector2(2.0_r * c, 3.0_r * -s), Vector2(2.0_r * s, 3.0_r * c));
    }
...
TEST_F(Matrix2x2Test, Transposition) {
    ...
    EXPECT_TRUE(m_14.IsEqualApprox(Matrix2x2(Vector2(1.0_r, 2.0_r), Vector2(3.0_r, 4.0_r))));
...
TEST_F(Matrix2x2Test, Determinant) { EXPECT_FLOAT_EQ(m_14.Determinant(), 1.0_r * 4.0_r - 2.0_r * 3.0_r); }
