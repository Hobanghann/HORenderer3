...
TEST_F(Transform3DTest, ApproximateEqualityCheck) {
  Transform3D t1(b_scale, Vector3(1.0_r, 2.0_r, 3.0_r));
  Transform3D t2(Basis3D(Vector3(2.000001_r, 0.0_r, 0.0_r),
                         Vector3(0.0_r, 3.000001_r, 0.0_r),
...
TEST_F(Transform3DTest, Scaling) {
  ...
  Matrix4x4 m_scale(
      Vector4(2.0_r, 0.0_r, 0.0_r, 0.0_r), Vector4(0.0_r, 3.0_r, 0.0_r, 0.0_r),
  ...
  Matrix4x4 m_uniform(
      Vector4(2.0_r, 0.0_r, 0.0_r, 0.0_r), Vector4(0.0_r, 2.0_r, 0.0_r, 0.0_r),
...
TEST_F(Transform3DTest, RotationAxisAngle) {
  ...
  Matrix4x4 m_rot = Matrix4x4(Vector4(m.row0), Vector4(m.row1), Vector4(m.row2),
                              Vector4::UNIT_W);
...
TEST_F(Transform3DTest, RotationEuler) {
  ...
  Matrix4x4 m_rot4(Vector4(m_rot.row0), Vector4(m_rot.row1),
                   Vector4(m_rot.row2), Vector4::UNIT_W);
  t1 = t;
  ...
  m_rot4 = Matrix4x4(Vector4(m_rot.row0), Vector4(m_rot.row1),
                     Vector4(m_rot.row2), Vector4::UNIT_W);
  t1 = t;
...
TEST_F(Transform3DTest, Translation) {
  ...
  Matrix4x4 m_trans(Vector4(1.0_r, 0.0_r, 0.0_r, trans.x),
                    Vector4(0.0_r, 1.0_r, 0.0_r, trans.y),
                    Vector4(0.0_r, 0.0_r, 1.0_r, trans.z),
...
TEST_F(Transform3DTest, TransformAndInvTransform) {
  ...
  EXPECT_TRUE(
      t.InvTransform(v).IsEqualApprox((m.Inverse() * vh).ToCartesian()));

  EXPECT_FALSE(t_non_ortho.InvTransformFast(v).IsEqualApprox(
      (t_non_ortho.ToMatrix().Inverse() * vh).ToCartesian()));

  EXPECT_TRUE(t_rot.InvTransformFast(v).IsEqualApprox(
      (t_rot.ToMatrix().Inverse() * vh).ToCartesian()));
}
