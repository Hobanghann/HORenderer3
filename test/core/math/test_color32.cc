...
TEST(Color32Test, Constructors) {
    ...
    Color32 c2(static_cast<uint8_t>(300), static_cast<uint8_t>(300), static_cast<uint8_t>(300),
               static_cast<uint8_t>(300));
    EXPECT_EQ(c2.r, 44);
    EXPECT_EQ(c2.g, 44);
    EXPECT_EQ(c2.b, 44);
    EXPECT_EQ(c2.a, 44);

    Color32 c3(static_cast<uint8_t>(-10), static_cast<uint8_t>(-10), static_cast<uint8_t>(-10),
...
TEST(Color32Test, Luminance) {
    ...
    EXPECT_NEAR(lum_custom, 0.3_r * 100 + 0.59_r * 150 + 0.11_r * 200, math::EPSILON_CMP);
}
