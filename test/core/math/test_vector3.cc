...
TEST_F(Vector3Test, UnaryMinus) { EXPECT_EQ(-v_123, Vector3(-1.0_r, -2.0_r, -3.0_r)); }
...
TEST_F(Vector3Test, CrossProduct) {
    ...
    EXPECT_TRUE(v_unitx.Cross(v_unitx).IsEqualApprox(Vector3(0.0_r, 0.0_r, 0.0_r)));
    EXPECT_TRUE(v_unitx.Cross(-v_unitx).IsEqualApprox(Vector3(0.0_r, 0.0_r, 0.0_r)));
    Vector3 c = v_123.Cross(v_345);
    EXPECT_TRUE(c.IsEqualApprox(Vector3(-2.0_r, 4.0_r, -2.0_r)));
    EXPECT_TRUE(v_unitx.Cross(v_unity).IsEqualApprox(Vector3(0.0_r, 0.0_r, 1.0_r)));
    EXPECT_TRUE(v_unity.Cross(v_unitx).IsEqualApprox(Vector3(0.0_r, 0.0_r, -1.0_r)));
}
...
TEST_F(Vector3Test, ToHomogeneous) { EXPECT_EQ(v_123.ToHomogeneous(), Vector4(1.0_r, 2.0_r, 3.0_r, 1.0_r)); }
