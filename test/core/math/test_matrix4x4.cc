...
class Matrix4x4Test : public ::testing::Test {
   protected:
    void SetUp() override {
        m_default = Matrix4x4();
        m_eye = Matrix4x4(Vector4(1.0_r, 0.0_r, 0.0_r, 0.0_r), Vector4(0.0_r, 1.0_r, 0.0_r, 0.0_r),
                          Vector4(0.0_r, 0.0_r, 1.0_r, 0.0_r), Vector4(0.0_r, 0.0_r, 0.0_r, 1.0_r));

        m_116 = Matrix4x4(Vector4(1.0_r, 2.0_r, 3.0_r, 4.0_r), Vector4(5.0_r, 6.0_r, 7.0_r, 8.0_r),
                          Vector4(9.0_r, 10.0_r, 11.0_r, 12.0_r), Vector4(13.0_r, 14.0_r, 15.0_r, 16.0_r));

        m_161 = Matrix4x4(Vector4(16.0_r, 15.0_r, 14.0_r, 13.0_r), Vector4(12.0_r, 11.0_r, 10.0_r, 9.0_r),
                          Vector4(8.0_r, 7.0_r, 6.0_r, 5.0_r), Vector4(4.0_r, 3.0_r, 2.0_r, 1.0_r));

        const real angle = PI / 4.0_r;
        const real s = std::sin(angle);
        const real c = std::cos(angle);
        m_orthonormal = Matrix4x4(Vector4(c, -s, 0.0_r, 0.0_r), Vector4(s, c, 0.0_r, 0.0_r),
                                  Vector4(0.0_r, 0.0_r, 1.0_r, 0.0_r), Vector4(0.0_r, 0.0_r, 0.0_r, 1.0_r));
        m_orthogonal =
            Matrix4x4(Vector4(2.0_r * c, -3.0_r * s, 0.0_r, 0.0_r), Vector4(2.0_r * s, 3.0_r * c, 0.0_r, 0.0_r),
                      Vector4(0.0_r, 0.0_r, 1.0_r, 0.0_r), Vector4(0.0_r, 0.0_r, 0.0_r, 1.0_r));
        m_non_singular = Matrix4x4(Vector4(1.0_r, 2.0_r, 3.0_r, 4.0_r), Vector4(5.0_r, 6.0_r, 7.0_r, 8.0_r),
                                   Vector4(2.0_r, 6.0_r, 4.0_r, 8.0_r), Vector4(3.0_r, 1.0_r, 1.0_r, 2.0_r));
    }

    Matrix4x4 m_default, m_eye, m_116, m_161, m_orthogonal, m_orthonormal, m_non_singular;
};
...
TEST_F(Matrix4x4Test, MatrixMultiplication) {
    Matrix4x4 expected(Vector4(80.0_r, 70.0_r, 60.0_r, 50.0_r), Vector4(240.0_r, 214.0_r, 188.0_r, 162.0_r),
                       Vector4(400.0_r, 358.0_r, 316.0_r, 274.0_r), Vector4(560.0_r, 502.0_r, 444.0_r, 386.0_r));
...
TEST_F(Matrix4x4Test, ScalarDivision) {
    ...
    EXPECT_EQ(div.row0, Vector4(1.0_r / 2.0_r, 2.0_r / 2.0_r, 3.0_r / 2.0_r, 4.0_r / 2.0_r));
    EXPECT_EQ(div.row1, Vector4(5.0_r / 2.0_r, 6.0_r / 2.0_r, 7.0_r / 2.0_r, 8.0_r / 2.0_r));
    EXPECT_EQ(div.row2, Vector4(9.0_r / 2.0_r, 10.0_r / 2.0_r, 11.0_r / 2.0_r, 12.0_r / 2.0_r));
    EXPECT_EQ(div.row3, Vector4(13.0_r / 2.0_r, 14.0_r / 2.0_r, 15.0_r / 2.0_r, 16.0_r / 2.0_r));

    m_116 /= 2.0_r;
    EXPECT_EQ(m_116.row0, Vector4(1.0_r / 2.0_r, 2.0_r / 2.0_r, 3.0_r / 2.0_r, 4.0_r / 2.0_r));
    EXPECT_EQ(m_116.row1, Vector4(5.0_r / 2.0_r, 6.0_r / 2.0_r, 7.0_r / 2.0_r, 8.0_r / 2.0_r));
    EXPECT_EQ(m_116.row2, Vector4(9.0_r / 2.0_r, 10.0_r / 2.0_r, 11.0_r / 2.0_r, 12.0_r / 2.0_r));
    EXPECT_EQ(m_116.row3, Vector4(13.0_r / 2.0_r, 14.0_r / 2.0_r, 15.0_r / 2.0_r, 16.0_r / 2.0_r));
...
TEST_F(Matrix4x4Test, ComparisonOperators) {
    Matrix4x4 a(Vector4(1.0_r, 2.0_r, 3.0_r, 4.0_r), Vector4(5.0_r, 6.0_r, 7.0_r, 8.0_r),
                Vector4(9.0_r, 10.0_r, 11.0_r, 12.0_r), Vector4(13.0_r, 14.0_r, 15.0_r, 16.0_r));
    EXPECT_TRUE(m_116 == a);
...
TEST_F(Matrix4x4Test, ApproximateEqualityCheck) {
    Matrix4x4 near_116(Vector4(1.000001_r, 2.000001_r, 3.000001_r, 4.000001_r),
...
TEST_F(Matrix4x4Test, Orthogonalization) {
    ...
    EXPECT_NEAR(o.col0().Magnitude(), m_non_singular.col0().Magnitude(), EPSILON_CMP);
    EXPECT_NEAR(o.col1().Magnitude(), m_non_singular.col1().Magnitude(), EPSILON_CMP);
    EXPECT_NEAR(o.col2().Magnitude(), m_non_singular.col2().Magnitude(), EPSILON_CMP);
    EXPECT_NEAR(o.col3().Magnitude(), m_non_singular.col3().Magnitude(), EPSILON_CMP);
...
TEST_F(Matrix4x4Test, Inversion) {
    Matrix4x4 m(Vector4(1.0_r, 0.0_r, 0.0_r, 0.0_r), Vector4(0.0_r, 2.0_r, 0.0_r, 0.0_r),
                Vector4(0.0_r, 0.0_r, 3.0_r, 0.0_r), Vector4(0.0_r, 0.0_r, 0.0_r, 1.0_r));
    Matrix4x4 expected(Vector4(1.0_r, 0.0_r, 0.0_r, 0.0_r), Vector4(0.0_r, 0.5_r, 0.0_r, 0.0_r),
                       Vector4(0.0_r, 0.0_r, 1.0_r / 3.0_r, 0.0_r), Vector4(0.0_r, 0.0_r, 0.0_r, 1.0_r));
    ...
    Matrix4x4 singular(Vector4(1.0_r, 2.0_r, 3.0_r, 4.0_r), Vector4(2.0_r, 4.0_r, 6.0_r, 8.0_r),
                       Vector4(3.0_r, 6.0_r, 9.0_r, 12.0_r), Vector4(4.0_r, 8.0_r, 12.0_r, 16.0_r));
...
TEST_F(Matrix4x4Test, Trace) { EXPECT_FLOAT_EQ(m_116.Trace(), 1.0_r + 6.0_r + 11.0_r + 16.0_r); }
