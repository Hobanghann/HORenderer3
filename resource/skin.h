...
namespace ho {
    ...
    struct Skin {
        ...
        ALWAYS_INLINE const Transform3D& GetInverseBindTransform(uint32_t index) const {
        ...
        ALWAYS_INLINE uint32_t GetBindSubMeshIndex(uint32_t bone_index, uint32_t index) const {
