    ...
    struct Animation {
        ...
        struct SkeletalTrack {
            ...
            SkeletalTrack(size_t p_bone_index, std::vector<TranslationKey>&& p_translation_key_sequence,
                          ...
                          ExtrapolationMode p_pre_mode, ExtrapolationMode p_post_mode) noexcept
        ...
        Animation() = default;
        Animation(std::string&& p_name, real p_duration, std::vector<SkeletalTrack>&& p_skeletal_tracks,
