...
namespace ho {
    ...
    const Mesh* ResourceManager::GetMesh(ResourceID id) const { return mesh_pool_.Get(id); }

    const Skeleton* ResourceManager::GetSkeleton(ResourceID id) const { return skeleton_pool_.Get(id); }

    const Animation* ResourceManager::GetAnimation(ResourceID id) const { return animation_pool_.Get(id); }

    const Skin* ResourceManager::GetSkin(ResourceID id) const { return skin_pool_.Get(id); }

    const Material* ResourceManager::GetMaterial(ResourceID id) const { return material_pool_.Get(id); }

    const Texture* ResourceManager::GetTexture(ResourceID id) const { return texture_pool_.Get(id); }

    bool ResourceManager::HasMesh(ResourceID id) const { return mesh_pool_.Has(id); }

    bool ResourceManager::HasSkeleton(ResourceID id) const { return skeleton_pool_.Has(id); }

    bool ResourceManager::HasAnimation(ResourceID id) const { return animation_pool_.Has(id); }

    bool ResourceManager::HasSkin(ResourceID id) const { return skin_pool_.Has(id); }

    bool ResourceManager::HasMaterial(ResourceID id) const { return material_pool_.Has(id); }

    bool ResourceManager::HasTexture(ResourceID id) const { return texture_pool_.Has(id); }
