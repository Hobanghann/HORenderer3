...
namespace ho {
    ...
    void vgGetTexImage(VGenum target, VGint level, VGenum format, VGenum type, void* pixels);
    ...
    // INLINE constexpr VGenum VG_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS = 0x8C8A;
    ...
    // INLINE constexpr VGenum VG_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE = 0x8CD3;
